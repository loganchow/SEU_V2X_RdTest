// Generated by gencpp from file test_run1/qtGUI.msg
// DO NOT EDIT!


#ifndef TEST_RUN1_MESSAGE_QTGUI_H
#define TEST_RUN1_MESSAGE_QTGUI_H
...
struct qtGUI_
{
  typedef qtGUI_<ContainerAllocator> Type;
  ...
  qtGUI_(const ContainerAllocator& _alloc)
    : EgoSpeed(0.0)
    , PreSpeed(0.0)
    , LimitSpeed(0.0)
    , Dis2Stopline(0.0)
  ...
  _Dis2Stopline_type Dis2Stopline;
   ...
   typedef uint8_t _intersectionID_type;
  ...
  typedef boost::shared_ptr< ::test_run1::qtGUI_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::test_run1::qtGUI_<ContainerAllocator> const> ConstPtr;

}; // struct qtGUI_

typedef ::test_run1::qtGUI_<std::allocator<void> > qtGUI;

typedef boost::shared_ptr< ::test_run1::qtGUI > qtGUIPtr;
typedef boost::shared_ptr< ::test_run1::qtGUI const> qtGUIConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::test_run1::qtGUI_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::test_run1::qtGUI_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::test_run1::qtGUI_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::test_run1::qtGUI_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test_run1::qtGUI_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test_run1::qtGUI_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test_run1::qtGUI_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test_run1::qtGUI_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::test_run1::qtGUI_<ContainerAllocator> >
{
  ...
  static const char* value(const ::test_run1::qtGUI_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa8906a8e43de075aULL;
  static const uint64_t static_value2 = 0x68220d54f4b7c0ceULL;
};

template<class ContainerAllocator>
struct DataType< ::test_run1::qtGUI_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::test_run1::qtGUI_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::test_run1::qtGUI_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::test_run1::qtGUI_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_run1::qtGUI_<ContainerAllocator>& v)
  {
    s << indent << "EgoSpeed: ";
    ...
    Printer<uint8_t>::stream(s, indent + "  ", v.intersectionID);
    s << indent << "Latitude: ";
...
#endif // TEST_RUN1_MESSAGE_QTGUI_H
