// Generated by gencpp from file test_run1/qt_GUI.msg
// DO NOT EDIT!


#ifndef TEST_RUN1_MESSAGE_QT_GUI_H
#define TEST_RUN1_MESSAGE_QT_GUI_H
...
struct qt_GUI_
{
  ...
  typedef boost::shared_ptr< ::test_run1::qt_GUI_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::test_run1::qt_GUI_<ContainerAllocator> const> ConstPtr;

}; // struct qt_GUI_

typedef ::test_run1::qt_GUI_<std::allocator<void> > qt_GUI;

typedef boost::shared_ptr< ::test_run1::qt_GUI > qt_GUIPtr;
typedef boost::shared_ptr< ::test_run1::qt_GUI const> qt_GUIConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::test_run1::qt_GUI_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::test_run1::qt_GUI_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::test_run1::qt_GUI_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::test_run1::qt_GUI_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test_run1::qt_GUI_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::test_run1::qt_GUI_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test_run1::qt_GUI_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::test_run1::qt_GUI_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::test_run1::qt_GUI_<ContainerAllocator> >
{
  ...
  static const char* value(const ::test_run1::qt_GUI_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa8906a8e43de075aULL;
  static const uint64_t static_value2 = 0x68220d54f4b7c0ceULL;
};

template<class ContainerAllocator>
struct DataType< ::test_run1::qt_GUI_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::test_run1::qt_GUI_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::test_run1::qt_GUI_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::test_run1::qt_GUI_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::test_run1::qt_GUI_<ContainerAllocator>& v)
  {
    s << indent << "EgoSpeed: ";
...
#endif // TEST_RUN1_MESSAGE_QT_GUI_H
