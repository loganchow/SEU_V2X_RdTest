...
"""autogenerated by genpy from test_run1/qtGUI.msg. Do not edit."""
import sys
...
class qtGUI(genpy.Message):
  _md5sum = "a8906a8e43de075a68220d54f4b7c0ce"
  _type = "test_run1/qtGUI"
...
"""
  ...
  _slot_types = ['float64','float64','float64','float64','uint8','float64','float64','float64','float64','float64','uint8','uint8','float64','float64','uint8','float64','float64','uint8','uint8','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(qtGUI, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4dB5d2B2dB2d2Bd().pack(_x.EgoSpeed, _x.PreSpeed, _x.LimitSpeed, _x.Dis2Stopline, _x.intersectionID, _x.Latitude, _x.Longitude, _x.Height, _x.upperSpeed, _x.bottomSpeed, _x.keepCurSpeed, _x.Str_is_val, _x.StrColor, _x.StrlikelyEndTime, _x.Left_is_val, _x.LeftColor, _x.LeftlikelyEndTime, _x.Right_is_val, _x.RightColor, _x.RightlikelyEndTime))
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_4dB5d2B2dB2d2Bd = None
def _get_struct_4dB5d2B2dB2d2Bd():
    global _struct_4dB5d2B2dB2d2Bd
    if _struct_4dB5d2B2dB2d2Bd is None:
        _struct_4dB5d2B2dB2d2Bd = struct.Struct("<4dB5d2B2dB2d2Bd")
    return _struct_4dB5d2B2dB2d2Bd
